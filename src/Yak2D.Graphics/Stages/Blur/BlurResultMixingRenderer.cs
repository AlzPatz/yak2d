...
{
    public class BlurResultMixingRenderer : IBlurResultMixingRenderer
    {
        ...
        private float _currentMixAmount = 0.5f;

        public BlurResultMixingRenderer(ISystemComponents systemComponents,
        ...
        private void CreateShadersAndFactorsUniform()
        {
            ...
            _shaderPackage = _shaderLoader.CreateShaderPackage("Vertex2D", AssetSourceEnum.Embedded,"BlurMixFragment", AssetSourceEnum.Embedded, vertexLayout, uniformDescriptions);
